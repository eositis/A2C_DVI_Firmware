...
- **RM_CLAMP color mapping**: `clamp_improved_lut.py` now uses sRGB-space nearest-neighbor matching instead of TMDS-space weighted L2. Colors should better match the expected LORES palette.
